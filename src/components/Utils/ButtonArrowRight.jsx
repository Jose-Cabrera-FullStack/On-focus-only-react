...
const ButtonArrowRight = ({margin, icon, text, background, width, onClick}) => {
  return (
    <button onClick={onClick} className={"btn__secundary btn__secundary--buy discovery__box__position"+ " "+ background + " " + margin + " " + width}>
