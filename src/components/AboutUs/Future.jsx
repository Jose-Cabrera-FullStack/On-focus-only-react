...
const Future = (props) => (
    <section className="about__us__focus__future">
       <div className="flex display__screen__mobile__without__flex">
            <img className="about__us__focus__future__img display__screen__desktop" src={Logo} alt="Logo de Onfocus"/>
            <img className="display__screen__mobile" src={props.icon} alt="Logo de Onfocus"/>
            <div>
