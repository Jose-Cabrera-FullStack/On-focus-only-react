...
import MapWithData from '../../assets/static/images/img/map-with-data.png'
            ...
            <div className="flex display__screen__mobile__without__flex">
                ...
                <div>
                    ...
                    <figure className="about__us__focus__map__inside__data__geo display__screen__mobile">
                        <img className="about__us__focus__map__inside__data__geo__img" src={Mapa} alt="Mapa de donde operamos"/>
                    </figure>
                </div>
