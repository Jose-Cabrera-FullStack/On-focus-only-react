...
const Principal = () => (
    <section className="home__view ">
      ...
      <div className="home__view__title">
        <h1 className="slide-in-bottom-3 display__screen__desktop">En la misión de empoderar 100</h1>
        <h1 className="slide-in-bottom-4 display__screen__desktop">millones de personas a través del</h1>
        <h1 className="slide-in-bottom-5 display__screen__desktop">conocimiento.</h1>
        <h1 className="slide-in-bottom-3 display__screen__mobile">Educar 1 millón de personas</h1>
        <h1 className="slide-in-bottom-5 display__screen__mobile">para que logren el éxito.</h1>
      </div>
      ...
      <button className="btn__primary btn__primary--fix btn__primary--media">Descubrí más</button>
    </section>
)
