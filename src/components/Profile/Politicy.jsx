  ...
  return (
    ...
    <div className="flex display__screen__mobile__without__flex">
        <div>
            ...
            className={isSwitch === "" ? "btn__secundary btn__secundary--buy btn__secundary--politicy btn__secundary--buy--select btn__secundary--politicy--select":"btn__secundary btn__secundary--buy btn__secundary--politicy"}>
            ...
            <button 
            onClick={TermsMethod} 
            className={isSwitch === "Terminos" ? "btn__secundary btn__secundary--buy btn__secundary--politicy btn__secundary--buy--select btn__secundary--politicy--select":"btn__secundary btn__secundary--buy btn__secundary--politicy"}>
            ...
            className={isSwitch === "Centro" ? "btn__secundary btn__secundary--buy btn__secundary--politicy btn__secundary--buy--select btn__secundary--politicy--select":"btn__secundary btn__secundary--buy btn__secundary--politicy"}>
