...
const Module = ({text, buyed}) => {
    ...
    return(
    <div>
        <div className="course__module__element course__module__element--teacher" onClick={toggleTrueFalse}>
            <div>
                <h3 className="course__module__element__title--help__center course__module__element__title--teacher">¿Lorem ipsum dolor sit amet?</h3>
        ...
        <ModuleInside text={text ? text : 'hola'} isToggled={isToggled} buyed={buyed}/>
    </div>
)}
