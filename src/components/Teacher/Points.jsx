...
const Points = (props) => (
        ...
        <div className="how__we__tech__info">
          ...
          <h5 className="how__we__tech__info__title">Enseña una vez y gana para siempre.</h5>
        ...
        <div className="how__we__tech__info">
          ...
          <h5 className="how__we__tech__info__title">Tu enseña y nos encargamos del resto.</h5>
          <p className="how__we__tech__info__text teacher__points__text">
        ...
        <div className="how__we__tech__info">
          ...
          <h5 className="how__we__tech__info__title">Consigue consultorías privadas.</h5>
          <p className="how__we__tech__info__text teacher__points__text">
        ...
        <div className="how__we__tech__info">
          ...
          <h5 className="how__we__tech__info__title">Inspira y transmite tu conocimiento a todo Hispanoamérica.</h5>
          <p className="how__we__tech__info__text teacher__points__text">
